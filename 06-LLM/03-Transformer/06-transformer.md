...
> [!abstract] 学习目标
> 本讲义为 [[01-transformer-练习题|Transformer 纸笔练习题]] 配套资料。读完后，应能从 shape 推导 self-attention，解释 mask、位置编码、Pre-LN DecoderBlock、训练与生成流程，并估算 attention 和 KV cache 的资源开销。

## 导航

- 学习路线：[[01-transformer|Transformer 学习与实现]]
- 配套测试：[[01-transformer-练习题|Transformer 纸笔练习题]]
- 前置速查：[[00-shape-cheatsheet|Video MLLM Shape Cheatsheet]]
- 下一阶段：[[02-vit|ViT]]
...
> [!success] 下一步
> 完成上述自检后，独立作答 [[01-transformer-练习题|Transformer 纸笔练习题]]。遇到错误时，不要只抄答案：回到对应章节重新从 shape 和信息可见性推导。
