...
> [!abstract] 阶段目标
> 对应 [[RoadMap#阶段 2：ViT|RoadMap 阶段 2]]。掌握 pixels 如何变成 patch tokens，以及分辨率、patch size 和特殊 token 如何决定 $N$。

## 导航

- 前置：[[01-transformer|01 Transformer]]
- 下一阶段：[[03-clip-siglip|03 CLIP 与 SigLIP]]
- Trace 目录：[[trace-实验模板|Trace 实验模板]]

## 学习资料

| 类型 | 文件 | 阅读范围 |
| --- | --- | --- |
| 原始论文 | [[2010.11929-vit.pdf\|ViT PDF]] | Figure 1、§3、§3.1、§3.2、§4.5 |
| 官方代码 | [[google-vision-transformer-main.zip\|Google Vision Transformer Snapshot]] | Config、patch embedding、position embedding |
| 模型文档 | [Hugging Face ViT Docs](https://huggingface.co/docs/transformers/model_doc/vit) | ViTConfig、ViTModel、hidden states |
| 课程复习 | [[lecture17-multimodality.py\|CS336 Lecture 17 Source]] | ViT / encoding images |
