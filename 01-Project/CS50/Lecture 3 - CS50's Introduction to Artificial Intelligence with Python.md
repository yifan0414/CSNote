...
![[_assets/images/cb04397b80fcb8a39d723d19e490b7f1_MD5.png]]
...
![[_assets/images/033d40d75953a0b016093503b53d5e64_MD5.png]]
...
![[_assets/images/2ff0e577a1d21199a678a85ea339a373_MD5.png]]
...
![[_assets/images/e0a3d3f52786e17e837452f8c2d26e68_MD5.png]]
...
![[_assets/images/bf8d7c5a9a6591f415cfdb5f465de934_MD5.png]]
...
![[_assets/images/2bf801063bff354c638fe430a5e01541_MD5.png]]
...
Although local search algorithms don’t always give the best possible solution, they can often give a **good enough solution** in situations where considering every possible state is ***computationally infeasible***.(取舍)
...
- for *t* = 1 to *max*:
	...
	- if *ΔE* > 0:
		- *current* = *neighbor*
	- with probability e^( *ΔE/T* ) set *current* = *neighbor* (概率)
- return *current*
...
![[_assets/images/5f6fd1eb579f5672a98f9c47871fd428_MD5.png]]
...
- A **cost function** that we want to minimize: $c_{1}x_{1} + c_{2}x_{2} + … + c_{n}x_{n}$. Here, each $x_{\_}$ is a variable and it is associated with some cost $c_{\_}$.
...
![[_assets/images/5b39e5df1a2cfeaf315db5493acf465d_MD5.png]]
...
![[_assets/images/e8526737632691a647cd94d4fff2ecb1_MD5.png]]
...
![[_assets/images/15d0546b3cba125149af4385a8952c02_MD5.png]]
...
![[_assets/images/d49e00442e535f1f17c6e880910be43e_MD5.png]]
...
![[_assets/images/fc7dfe7cf84dce0851f9c720075a12e5_MD5.png]]
...
![[_assets/images/eb25a2ef117552043a61e1e722db71f0_MD5.png]]
