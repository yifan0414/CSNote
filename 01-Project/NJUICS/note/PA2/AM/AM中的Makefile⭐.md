...
![[_assets/images/ab4dcdc29e3cbc516c33ffd1ff288b61_MD5.png]]

这里的意思是如果命令行未指定 `MAKECMDGOALS` 的值，那么默认是 img。这里决定了 nemu 的运行规则，在 `nemu.mk` 中定义

![[_assets/images/9b4600cc0e13cb712fa01e5fed3aae7f_MD5.png]]
...
> ![[_assets/images/3b49c1fdad1d615e30a7a39e27c67b65_MD5.png]]
