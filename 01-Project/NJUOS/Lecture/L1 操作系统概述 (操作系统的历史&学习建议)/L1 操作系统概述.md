...
>>```
>
> ![[_assets/images/f0f7020f92f4c9f0a1dda2abe4bbfeea_MD5.png|600]]


如果你阅读示例代码遇到困难，可以想一想今天的大语言模型已经可以 “阅读理解” 程序的行为 (不过也有错误的地方)。你可以相信课堂上的示例已经尽可能做到 “可读”；你只要学习相关的语法特性，就能理解示例代码。

![[_assets/images/jyyospic1.png|chatgpt显示结果]]
...
![[_assets/images/Pasted image 20230609011914.png]]
