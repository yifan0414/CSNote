...
测试如下：
![[_assets/images/b560de330f372824f20afa778ac85db5_MD5.png|500]]

默认情况下并不生成 core dump 的文件（保存了错误状态信息），以防止生成大量冗余文件，可以通过 `ulimit -a` 查看。

![[_assets/images/164fac057062bc97093012ab4c4c84bf_MD5.png|500]]

我们可以通过 `ulimit -c` 修改 `core file size` 这个值

![[_assets/images/929fff976f5eaff5f7eb0c3fb670a3e6_MD5.png|500]]

还需要用到 `sudo sysctl -w kernel.core_pattern=core` 来修改 `/proc/sys/kernel/core_pattern` 的值。
![[_assets/images/3af7cc383e0655fe6343fa710504e977_MD5.png|500]]

![[_assets/images/8036e1c8baad552f73974d4041875b6b_MD5.png|500]]
