...
3.  将版本历史可视化并进行探索
    ...
    ![[_assets/images/7febabee71e0f0f7a65132f144c03408_MD5.png]]
...
4.  是谁最后修改了 README.md文件？（提示：使用 git log 命令并添加合适的参数）
    ...
    ![[_assets/images/8925e68a6e7caa5851908177ce2a1e4f_MD5.png]]
...
5.  最后一次修改_config.yml 文件中 collections: 行时的提交信息是什么？（提示：使用 git blame 和 git show）
    ...
    ![[_assets/images/bf2aada32584133bd0bebe05a6262b66_MD5.png]]
    
    ```bash
     git show a88b4eac
    ```
    
    ![[_assets/images/c225a0daab5432d8471c3aa40a9fbcc8_MD5.png]]
...
7.  首先提交一些敏感信息
    ...
    ![[_assets/images/89abcd91f0ace5ad297b2ad0d2893f30_MD5.png]]
...
8.  使用`git filter-branch`清除提交记录
    ...
    文件已经删除![[_assets/images/a313d9b3183ab76070456e07efbca1d4_MD5.png]]提交记录已经删除![[_assets/images/5449a101a5b8af2535a62c35ad178c3a_MD5.png]]
    
9.  从 GitHub 上克隆某个仓库，修改一些文件。当您使用 git stash 会发生什么？当您执行 git log –all –oneline 时会显示什么？通过 git stash pop 命令来撤销 git stash 操作，什么时候会用到这一技巧？![[_assets/images/70edd152f42e7b3664162abe6f94200a_MD5.png]]![[_assets/images/32f092b8a91c37db8acf94b4e4c8e2ea_MD5.png]]![[_assets/images/d817d77c35bcd7e8af2ee4dd11b6f59b_MD5.png]]![[_assets/images/160672d93eedb196cb1462e940110e4d_MD5.png]]
...
![[_assets/images/e2d7238f3cddd4e9360821b210198eec_MD5.png]]