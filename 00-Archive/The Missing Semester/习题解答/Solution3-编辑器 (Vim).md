...
3.  安装和配置一个插件： `ctrlp.vim`.
    ...
    3.  请阅读这个插件的[文档](https://github.com/ctrlpvim/ctrlp.vim/blob/master/readme.md)。 尝试用 CtrlP 来在一个工程文件夹里定位一个文件， 打开 Vim, 然后用 Vim 命令控制行开始 :CtrlP.![[_assets/images/3cf723b236c241950e062a1d44daad34_MD5.png]]
    4.  自定义 CtrlP： 添加 [configuration](https://github.com/ctrlpvim/ctrlp.vim/blob/master/readme.md#basic-options) 到你的 ~/.vimrc 来用按 Ctrl-P 打开 CtrlP
        ...
        ![[_assets/images/d21d93ef8195b47f32da5353e54a8dc0_MD5.png]]
...
7.  进一步自定义你的 ~/.vimrc 和安装更多插件。 安装插件最简单的方法是使用 Vim 的包管理器，即使用 vim-plug 安装插件：
    ...
    3.  在 vim 命令行中执行 `:PlugInstall`![[_assets/images/acd5efe2ba75125758039e3980bc58bb_MD5.png]]
