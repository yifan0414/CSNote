...
+   打开文件
    ...
    ![](../../_assets/images/0-1.png)
    
+   点击`Import`

    ![](../../_assets/images/0-2.png)

+   选择`vm1`并点击`Start`

    ![](../../_assets/images/0-3.png)

+   等待`vm1`启动

    ![](../../_assets/images/0-4.png)

+   启动`putty`，在`Host Name`或者`IP Address`中输入`localhost`。之后点击`Open`

    ![](../../_assets/images/0-5.png)

+   输入`user1`, `<ENTER>`, `123qwe`, `<ENTER>`。

    ![](../../_assets/images/0-6.png)
    
+   恭喜，你现在登入了`vm1`。

    ![](../../_assets/images/0-7.png)
