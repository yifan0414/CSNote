...
For now, we can assume that `put` and `get` are included in our language. In **Chapter 3** ([3.3.3](3_002e3.xhtml#g_t3_002e3_002e3)) we will see how to implement these and other operations for manipulating tables.
