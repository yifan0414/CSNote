...
![example](../../_assets/images/tikz16.png)
...
![example](../../_assets/images/tikz17.png)
...
![nets](../../_assets/images/tikz18.png)
...
![demon](../../_assets/images/tikz19.png)
...
![summary](../../_assets/images/tikz20.png)
...
![slightly change](../../_assets/images/tikz22.png)

权值的改变将会造成其相应神经元的输出激活 $a_j^l$ 的改变：

![another slightly change](../../_assets/images/tikz23.png)

从而，这个改变将会对下一层中*所有的*激活造成影响：

![a really big influence](../../_assets/images/tikz24.png)

这些改变同样地会对下一层造成影响，然后再下一层，如此传播到随后整个网络，直到最后一层，最终影响了代价函数：

![made a change to cost function](../../_assets/images/tikz25.png)
...
![for a single path](../../_assets/images/tikz27.png)
