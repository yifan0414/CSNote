...
![handwritten digis](mnist_100_digits.png)
...
![complicate perceptron](tikz1.png)
...
![four layers neural network](tikz11.png)
...
![three-layer neural network](tikz12.png)
...
![minist figure](mnist_top_left_feature.png)
...
![mnist digits](mnist_other_features.png)

把这四个图片组合起来会得到什么呢？

![在这里插入图片描述](mnist_complete_zero.png)
...
![four-layer neural network](tikz13.png)
...
![valley with ball](valley_with_ball.png)
...
![hard to recognize](mnist_really_bad_images.png)
...
![Einstein crop](Einstein_crop.jpg)
![aerospace](hubble.jpg)
