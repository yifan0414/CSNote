...
![network-5](../../_assets/images/4-network-5.png)
...
![anim-1](../../_assets/images/7-anim-1.gif)
...
![anim-2](../../_assets/images/8-anim-2.gif)

我们可以无限地增加权值，从而让其的表现无限地近似于阶跃函数。下面展示的是我将权值调整为 $w = 999$ 时的情况。这个展示是静态的，你不能改变其中的参数。

![999](../../_assets/images/9-high_weight_function.jpg)
...
![anim-3](../../_assets/images/10-anim-3.gif)

这样的话，我们只用一个参数 $s$ 就可以很好地描述隐藏神经元，即台阶的位置 $s = -b/w$。试着调整下图中 $s$ 的值：

![anim-4](../../_assets/images/11-anim-4.gif)
...
![network](../../_assets/images/12-network.png)
...
![anim-5](../../_assets/images/13-anim-5.gif)
...
![anim-8](../../_assets/images/18-anim-8.gif)
...
![network](../../_assets/images/19-network.png)
...
![weighted output](../../_assets/images/22-weighte-output.png)
...
![anim-11](../../_assets/images/23-anim-11.gif)
...
![anim-14](../../_assets/images/28-anim-14.gif)
...
![anim-15](../../_assets/images/29-anim-15.gif)
...
![anim-16](../../_assets/images/30-anim-16.gif)
...
![tower](../../_assets/images/31-tower.png)
如果我们可以构建这样的塔函数，那么我们就可以使用它们来近似任何函数。只需要添加足够多，在不同位置，有不同高度的塔即可：

![towers](../../_assets/images/32-towers.png)
...
![anim-17](../../_assets/images/33-anim-17.gif)
...
![anim-18](../../_assets/images/34-anim-18.gif)
...
![4d-tower](../../_assets/images/37-4d-tower.png)
...
![sigmoid](../../_assets/images/38-sigmoid.png)

如果我们考虑不同类型的神经元，例如使用其他的激活函数，$s(z)$：

![s(z)](../../_assets/images/39-other-activation-function.png)
...
![100](../../_assets/images/40-anim-20.gif)
...
![step](../../_assets/images/41-step.png)
...
![weighted input](../../_assets/images/22-weighte-output.png)

如果我们使用之前介绍的技巧，则隐藏神经元会试着产生如下的凸起函数：

![bump functions](../../_assets/images/43-bump-functions.png)
...
![scaled](../../_assets/images/44-scaled.png)

然后我们再用另外一系列隐藏神经元，同样计算 $\sigma^{-1} \circ f(x) / 2$，但是相对于上张图，我们将其平移凸起宽度一半的距离：

![half width](../../_assets/images/45-half-width.png)
