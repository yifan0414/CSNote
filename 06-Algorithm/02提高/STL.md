...
- 算法库 Algorithm
  ...
  - [x] [`reverse()`](https://zh.cppreference.com/w/cpp/algorithm/reverse) ✅ 2024-08-10
  - [ ] `shuffle()` C++11
...
- $\lfloor\dfrac{a}{b}\rfloor$
  - 别用：`floor(1.0 * a / b)`
  - 要用：`a / b`
- $\lceil\dfrac{a}{b}\rceil$
  - 别用：`ceil(1.0 * a / b)`
  - 要用：`(a + b - 1) / b`  （$\lceil\dfrac{a}{b}\rceil=\lfloor\dfrac{a+b-1}{b}\rfloor$）
