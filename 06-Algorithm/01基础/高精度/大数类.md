...
> Boy: Cache.
>
> Girl: Why? Do you mean that I am ***small and fast***?
>
> Boy: No, you're my hidden treasure, and every time I visit my memory because of missing you.
...
int main() {  
    ...
    num1 = "-123";  
    std::cout << num1.to_str() << std::endl;  
    num1 = "123";  
    std::cout << num1.to_str() << std::endl;  
    num2 = "--123";  
    num1 = num1 - num2;  
  
    // std::cout << num1.to_str() << " * " << num2.to_str() << " = " << result.to_str() << std::endl;  
    std::cout << num1.to_str();  
