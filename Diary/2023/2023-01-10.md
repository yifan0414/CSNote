...
![[_assets/images/f8870a48705ea0c4a45f7f35190277ef_MD5.png]]
...
![[_assets/images/a47fdc942319625b54c5d6b79ee75737_MD5.png]]

然后然后就是输出的主题还是之前 pygmentize 的默认主题
![[_assets/images/52430a71ec95256f284cdfdaf57e9289_MD5.png]]

可以在上面的回答找的文件，我这里是 `/Users/yifansu/miniforge3/lib/python3.10/site-packages/IPython/core/ultratb.py`

然后在这里面找到

![[_assets/images/f224fb6e1f4728803f70a32f7f718766_MD5.png]]
修改成 dracula 即可


>[!danger]
>ipython 的渲染用的是 pygment，所以配置颜色要去 pygment 的颜色库中找，一般是在安装环境下的包中
> ![[_assets/images/10771ddd216aefc6fc0749febeef6e34_MD5.png]]
