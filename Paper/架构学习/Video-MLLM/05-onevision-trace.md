...
> [!abstract] 阶段目标
> 对应 [[Paper/架构学习/RoadMap#阶段 7：LLaVA-OneVision|RoadMap 阶段 7]] 与 [[Paper/架构学习/RoadMap#阶段 8：代码追踪与性能剖析|阶段 8]]。以真实 checkpoint 与代码为准，追踪 video processor → frame sampling → SigLIP → spatial reduction → projector → Qwen2，并分段测量成本。

## 导航

- 前置：[[Paper/架构学习/Video-MLLM/04-blip-llava|04 BLIP 与 LLaVA]]
...
- Profiler 模板：[[Paper/架构学习/Video-MLLM/experiments/profiler/README|Profiler 实验模板]]
- 下一阶段：[[Paper/架构学习/Video-MLLM/06-compression-map|06 Compression Map]]
...
| 类型 | 文件 | 必读 / 检查范围 |
| --- | --- | --- |
| 原始论文 | [[Paper/架构学习/Video-MLLM/resources/papers/2408.03326-llava-onevision.pdf\|LLaVA-OneVision PDF]] | Figure 2-3、§3.1、§3.2、Appendix C.1；§5 选读 |
| 后续架构 | [[Paper/架构学习/Video-MLLM/resources/papers/2605.25979-llava-onevision2.pdf\|LLaVA-OneVision-2 PDF]] | 后续对照，不作为原始 OneVision trace 的定义依据 |
| 官方代码 | [[Paper/架构学习/Video-MLLM/resources/code/llava-next-main.zip\|LLaVA-NeXT / OneVision Snapshot]] | OneVision README、video inference、mm_utils、vision tower、projector |
...
| 课程复习 | [[Paper/架构学习/Video-MLLM/resources/courses/cs336/lecture17-multimodality.py\|CS336 Lecture 17 Source]] | SigLIP、AnyRes、OneVision single / multi-image / video |
...
| CS336 | [[Paper/架构学习/Video-MLLM/resources/courses/cs336/lecture02-resource-accounting.py\|Lecture 2 Source]] | dtype memory、FLOPs、arithmetic intensity、roofline |
| CS336 | [[Paper/架构学习/Video-MLLM/resources/courses/cs336/lecture10-inference.py\|Lecture 10 Source]] | TTFT、prefill / decode、KV cache、PagedAttention |
| CS336 作业 | [[Paper/架构学习/Video-MLLM/resources/courses/cs336/assignment2-systems.pdf\|A2 Systems Handout]] | §2 profiling / benchmarking、§4.1 attention benchmark |
| CS336 代码 | [[Paper/架构学习/Video-MLLM/resources/code/cs336-assignment2-systems-main.zip\|A2 Systems Code Snapshot]] | 复用 benchmark 结构 |
