...
> [!abstract] 阶段目标
> 对应 [[Paper/架构学习/RoadMap#阶段 5：BLIP 与 BLIP-2|RoadMap 阶段 5]] 与 [[Paper/架构学习/RoadMap#阶段 6：LLaVA|阶段 6]]。先理解跨模态交互和固定 query bottleneck，再沿 LLaVA 的 vision tower → projector → LLM 路径完成单图 trace。

## 导航

- 前置：[[Paper/架构学习/Video-MLLM/03-clip-siglip|03 CLIP 与 SigLIP]]
- 下一阶段：[[Paper/架构学习/Video-MLLM/05-onevision-trace|05 OneVision Trace]]
- Trace 模板：[[Paper/架构学习/Video-MLLM/experiments/traces/README|Trace 实验模板]]
- Compression Map：[[Paper/架构学习/Video-MLLM/06-compression-map|06 Compression Map]]
...
| 类型 | 文件 | 阅读 / 检查范围 |
| --- | --- | --- |
| 原始论文 | [[Paper/架构学习/Video-MLLM/resources/papers/2201.12086-blip.pdf\|BLIP PDF]] | Figure 2、§3、§3.1；区分 ITC / ITM / LM |
| 原始论文 | [[Paper/架构学习/Video-MLLM/resources/papers/2301.12597-blip2.pdf\|BLIP-2 PDF]] | Figure 1-3、§3.1-3.3；Q-Former 与两阶段训练 |
| 官方代码 | [[Paper/架构学习/Video-MLLM/resources/code/salesforce-lavis-main.zip\|Salesforce LAVIS Snapshot]] | BLIP / BLIP-2 config、Q-Former、query_tokens、generate |
...
| 类型 | 文件 | 阅读 / 检查范围 |
| --- | --- | --- |
| 原始论文 | [[Paper/架构学习/Video-MLLM/resources/papers/2304.08485-llava.pdf\|Visual Instruction Tuning PDF]] | Figure 1、§4、§4.1-4.2；projection 与两阶段训练 |
| 官方代码 | [[Paper/架构学习/Video-MLLM/resources/code/llava-main.zip\|LLaVA Official Snapshot]] | model builder、vision tower、mm_projector、image token replacement |
...
| 课程复习 | [[Paper/架构学习/Video-MLLM/resources/courses/cs336/lecture17-multimodality.py\|CS336 Lecture 17 Source]] | LLaVA 与 multimodal token 部分 |
