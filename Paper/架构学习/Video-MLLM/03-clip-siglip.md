...
> [!abstract] 阶段目标
> 对应 [[Paper/架构学习/RoadMap#阶段 3：CLIP|RoadMap 阶段 3]] 与 [[Paper/架构学习/RoadMap#阶段 4：SigLIP|阶段 4]]。重点区分 global frame relevance、patch features 和两种训练目标。

## 导航

- 前置：[[Paper/架构学习/Video-MLLM/02-vit|02 ViT]]
- 下一阶段：[[Paper/架构学习/Video-MLLM/04-blip-llava|04 BLIP 与 LLaVA]]
...
| 类型 | 文件 | 阅读范围 |
| --- | --- | --- |
| 原始论文 | [[Paper/架构学习/Video-MLLM/resources/papers/2103.00020-clip.pdf\|CLIP PDF]] | Figure 1、§2.3-2.5、Figure 3 |
| 官方代码 | [[Paper/架构学习/Video-MLLM/resources/code/openai-clip-main.zip\|OpenAI CLIP Snapshot]] | load、tokenize、encode_image、encode_text |
| 课程复习 | [[Paper/架构学习/Video-MLLM/resources/courses/cs336/lecture17-multimodality.py\|CS336 Lecture 17 Source]] | CLIP / ViT 部分 |

### SigLIP

| 类型 | 文件 | 阅读范围 |
| --- | --- | --- |
| 原始论文 | [[Paper/架构学习/Video-MLLM/resources/papers/2303.15343-siglip.pdf\|SigLIP PDF]] | Algorithm 1、§3.1-3.3、§4.1-4.2 |
| 官方代码 | [[Paper/架构学习/Video-MLLM/resources/code/google-big-vision-main.zip\|Google Big Vision Snapshot]] | SigLIP configs / image-text models |
