...
用一点点元编程 (meta-programming)；试一试 [log2.c](http://jyywiki.cn/pages/ICS/2020/demos/log2.c)
...
-   如果想了解 IEEE754，请阅读 D. Goldberg. [What every computer scientist should know about floating-point arithmetic](https://dl.acm.org/citation.cfm?id=103163). _ACM Computing Surveys_, 23 (1), 1991.
